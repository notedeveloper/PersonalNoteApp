...
public class WeekBar extends LinearLayout {
    ...
    public WeekBar(Context context) {
        super(context);
        if ("com.example.asus.calendar11.calendarview.WeekBar".equals(getClass().getName())) {
    ...
    void setup(CalendarViewDelegate delegate) {
        ...
        if ("com.example.asus.calendar11.calendarview.WeekBar".equalsIgnoreCase(getClass().getName())) {
