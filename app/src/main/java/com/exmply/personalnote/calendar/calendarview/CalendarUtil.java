 ...
 */
package com.exmply.personalnote.calendar.calendarview;
...
public final class CalendarUtil {
     ...
     */
    @Deprecated
    public static int getWeekCountBetweenYearAndYear(int minYear, int minYearMonth, int maxYear, int maxYearMonth, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     */
    @Deprecated
    public static int getWeekFromCalendarBetweenYearAndYear(Calendar calendar, int minYear, int minYearMonth, int weekStar) {
        java.util.Calendar date = java.util.Calendar.getInstance();
     ...
     */
    @Deprecated
    public static Calendar getFirstCalendarFromWeekCount(int minYear, int minYearMonth, int week, int weekStart) {
        java.util.Calendar date = java.util.Calendar.getInstance();
