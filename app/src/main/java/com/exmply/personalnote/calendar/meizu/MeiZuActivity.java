package com.exmply.personalnote.calendar.meizu;
...
public class MeiZuActivity extends BaseActivity implements
    ...
    protected void initData() {
        ...
        /*
         * mCalendarView.setSchemeDate(schemes) 此方法现在弃用，但不影响原来的效果，原因：数据量大时 size()>10000 ，遍历性能太差，超过Android限制的16ms响应，造成卡顿
         * 现在推荐使用 setSchemeDate(Map<String, Calendar> mSchemeDates)，Map查找性能非常好，经测试，50000以上数据，1ms解决
         */
        mCalendarView.setSchemeDate(schemes);
//        mCalendarView.setSchemeDate(Map<String,Calendar> mSchemeDates);
...
//
//        List<Calendar> schemes = new ArrayList<>();
//        schemes.add(getSchemeCalendar(year, month, day, 0xFFbc13f0, "记"));
//
//        Map<String, Calendar> map = new HashMap<>();
//        map.put(getSchemeCalendar(year,month,day,0xFFbc13f0,"记")).toString(),
//        getSchemeCalendar(year,month,day,0xFFbc13f0, "记");
    }
